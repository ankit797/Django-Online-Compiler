			...
			success: function(response){
				...
				if(cstat == "OK"){
					...
					if(rstat == "AC"){
						$(".outputerror").hide();
						$(".io-show").show();
						$(".outputo").html(response.run_status.output_html).css("color", "white");;
						if($("#user-input").prop('checked') == true)
							$(".outputi").html(input_given).css("color", "white");
						else
							$(".outputi").html("Standard input is empty").css("color", "white");
					}
					else{
						$(".io-show").show();
						$(".outputo").html("Standard output is empty").css("color", "white");
						if($("#user-input").prop('checked') == true)
							$(".outputi").html(input_given).css("color", "white");
						else
							$(".outputi").html("Standard input is empty").css("color", "white");
